 ...
 *   Time 2019/4/20
 **/
class OnlineSongListAdapter(val activity: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): RecyclerView.ViewHolder {
        return OnlineSongViewHolder(this, LayoutInflater.from(parent!!.context).inflate(if (isList) R.layout.item_song_playlist else R.layout.online_song_vh, null))
    }
