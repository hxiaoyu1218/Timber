package com.naman14.amber.widgets;
...
public class MusicVisualizer extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(getDimensionInPixel(0), getHeight() - (40 + random.nextInt((int) (getHeight() / 1.5f) - 25)), getDimensionInPixel(6), getHeight() - 15, paint);
        canvas.drawRect(getDimensionInPixel(9), getHeight() - (40 + random.nextInt((int) (getHeight() / 1.5f) - 25)), getDimensionInPixel(15), getHeight() -15, paint);
        canvas.drawRect(getDimensionInPixel(18), getHeight() - (40 + random.nextInt((int) (getHeight() / 1.5f) - 25)), getDimensionInPixel(24), getHeight() -15, paint);
    }
